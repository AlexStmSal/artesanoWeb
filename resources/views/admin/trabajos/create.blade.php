...
<h1 class="text-4xl uppercase mb-8">Añadir trabajo</h1>
...
<form action="{{ route('admin.trabajos.store') }}" method="POST" class="bg-white/20 p-8 rounded-lg max-w-xl mx-auto">
    @csrf
